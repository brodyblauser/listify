      ...
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button onClick={() => setShowUpgrade(false)} className="text-navy-400 hover:text-navy-200 text-sm">
              Back
            </button>
          </div>
        </div>
    ...
    <div className="py-14 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 bg-navy-600 text-navy-100 text-xs font-bold px-3 py-1.5 rounded-full mb-4 uppercase tracking-wider">
